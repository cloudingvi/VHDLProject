...
##USB HID (PS/2)
#set_property PACKAGE_PIN C17 [get_ports PS2clock]
#set_property IOSTANDARD LVCMOS33 [get_ports PS2clock]
#set_property PULLUP true [get_ports PS2clock]
...
##Quad SPI Flash
##Note that Cclock_0 cannot be placed in 7 series devices. You can access it using the
##STARTUPE2 primitive.
